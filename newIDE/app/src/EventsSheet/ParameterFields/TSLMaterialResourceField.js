...
export default (React.forwardRef<ParameterFieldProps, ParameterFieldInterface>(
  function TSLMaterialResourceField(props: ParameterFieldProps, ref) {
    ...
    if (!props.resourceManagementProps || !props.project) {
      console.error(
        'Missing project or resourceManagementProps for TSLMaterialResourceField'
      );
      return null;
    }
    ...
    return (
      <ResourceSelector
        ...
        floatingLabelText={<Trans>Choose the TSL material to use</Trans>}
